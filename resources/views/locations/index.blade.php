                            ...
                            @if(isset($locations))
                               ...
                               <tr>
                                 <td><a   href="#">{{$location->location_num}}</a></td>
                                     ...
                                     <td>              <div class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addlocationModal" data-bs-id="{{$location->id}}" data-bs-location_num="{{$location->location_num}}"
                                                             data-bs-desc="{{$location->location_desc}}" data-bs-enddt="{{$location->location_enddt}}" data-bs-status="{{$location->status}}"
