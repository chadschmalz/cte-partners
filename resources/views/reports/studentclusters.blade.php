...
<div class="container-fluid">
    ...
    <div class="card">
      <div class="card-header">
          <h4>Student Count by Clusters</h4>
        ...
        <table class="table table-sm table-striped display allDataTable"  id="allDataTable">
          ...
          <tr>
            ...
            <th scope="col" ></th>
              ...
              <tbody >
              <tr>
            <td scope="col" ><strong>1 School</strong></td>
            ...
            <?php $loctotal = 0;?>
                    <tr>
                      ...
                      @foreach($clusters as $c)
                            ...
                            ?>
                        <td style="text-align:center"><a href="/students/{{$selectedsemester}}/{{$key}}/all/{{$c->id}}" target="_blank">{{$locationclustertotal[$c->id]}} </a></td><td>({{ $clustertotals[$c->id] > 0 ? number_format($locationclustertotal[$c->id]/$clustertotals[$c->id] *100, 0, '.', '') : '0'}}%)</td>
          ...
          @endif
            ...
            <?PHP 
                if(!isset($semtotal[$c->id]))
                    $semtotal[$c->id] = 0;
            ?>
                <td style="text-align:center"><a href="/students/{{$selectedsemester}}/all/all/{{$c->id}}" target="_blank">{{$semtotal[$c->id]}}<a href="/students/{{$selectedsemester}}/{{$key}}/all/{{$c->id}}" target="_blank"></td>
